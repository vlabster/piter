...
<body>
  <div id="sidebar">
    ...
    <ul>
      <li> </li>
	  <div class = "otst">
      <li><div class = "col"><img src="img/logos/home_btn.png" width=24px heigth=24px>&nbsp;&nbsp;&nbsp;</div></li>
      ...
      <li><div class = "exit"><img src="img/logos/info_btn.png" width=24px heigth=24px>&nbsp;&nbsp;&nbsp;</div></li>
	  </div>   
    </ul>
  </div>
  <div id="mainpage">
